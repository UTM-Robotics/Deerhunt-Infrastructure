...
class LeaderboardRoute(Resource):
    ...
    parser.add_argument('event_id', type=str, required=True, help='This field cannot be left blank')
    ...
    def get(self):
        ...
        with LeaderboardManager() as leaderboardmanager:
            ...
            if all_team_ids:
                with TeamsManager(data['event_id']) as teamsmanager:
                    teams_leaderboard = teamsmanager.find_teams(all_team_ids['team_ids'])
