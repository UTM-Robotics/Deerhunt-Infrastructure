...
class StorageAPI:
    ...
    @staticmethod
    def prep_match_container(p1_team_name, p2_team_name):
        ...
        StorageAPI.copy_dir_contents(f'{StorageAPI.SUBMISSIONS_FOLDER}/{p1_team_name}',\
             f'{build_path}/p1')
        StorageAPI.copy_dir_contents(f'{StorageAPI.SUBMISSIONS_FOLDER}/{p2_team_name}',\
             f'{build_path}/p2')
        return build_path
